...
TEST_CASE("test broadword_loop_sdsl") {
    test_select_512<select_modes::broadword_loop_sdsl>();
}
TEST_CASE("test broadword_loop_succinct") {
    test_select_512<select_modes::broadword_loop_succinct>();
}
#ifdef __SSE4_2__
TEST_CASE("test builtin_loop_sdsl") {
    test_select_512<select_modes::builtin_loop_sdsl>();
}
TEST_CASE("test builtin_loop_succinct") {
    test_select_512<select_modes::builtin_loop_succinct>();
}
#endif
#ifdef __BMI2__
TEST_CASE("test builtin_loop_pdep") {
    test_select_512<select_modes::builtin_loop_pdep>();
}
#endif
#ifdef __AVX512VL__
