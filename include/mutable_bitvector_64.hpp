...
/* Specialization of the class mutable_bitvector. In this case we use blocks of
 * 64 bits, instead of 256 bits. */
template <typename PrefixSums, rank_modes RankMode, select_modes SelectMode>
struct mutable_bitvector_64 {
    mutable_bitvector_64() {}
    ...
    static std::string name() {
        return "mutable_bitvector_64<" + PrefixSums::name() + "," +
